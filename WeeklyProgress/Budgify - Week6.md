...
1. Gelişmiş Finansal Dashboard (Overview Screen):
...
2. Dinamik Gelir/Gider Trend Grafiği (DailyTrendChart):
...
3. Kategori Bazlı Harcama Dağılımı (Donut Chart):
...
4. Esnek Zaman Filtreleme (Period Toggle):
